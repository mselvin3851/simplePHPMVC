 ...
 function run()
 {
    ...
    if($_SERVER["REQUEST_METHOD"] === "POST")
    {
        ...
        {    
            ...
            {
                case 'INS':
                    insertProducto($arrViewData['dscprd'], $arrViewData['sdscprd'], $arrViewData['ldscprd'], $arrViewData['skuprd'], $arrViewData['bcdprd'],
                ...
                case 'UPD':
                    updateProducto($arrViewData['dscprd'], $arrViewData['sdscprd'], $arrViewData['ldscprd'], $arrViewData['skuprd'], $arrViewData['bcdprd'],
                                   $arrViewData['stkprd'], $arrViewData['typprd'], $arrViewData['prcprd'],  $arrViewData['urlprd'], $arrViewData['urlthbprd'],
